...
+ (void)load {
    [TCJSModule registerGlobalModuleNamed:@"fs" withBlock:^TCJSModule * _Nonnull(JSContext * _Nonnull context) {
        return [[TCJSModule alloc ] initWithExports:[JSValue valueWithObject:[TCJSFileSystem defaultFileSystem]
                                                                   inContext:context]
                                            context:context];
    }];
}
