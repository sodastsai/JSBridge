...
+ (void)load {
    [TCJSModule registerGlobalModuleNamed:@"dispatch" withBlock:^TCJSModule *(JSContext *context) {
        return [TCJSModule moduleWithExports:[JSValue valueWithObject:[TCJSDispatchManager sharedManager]
                                                            inContext:context]];
    }];
}
